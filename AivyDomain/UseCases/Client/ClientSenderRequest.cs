...
namespace AivyDomain.UseCases.Client
{
    ...
    public static class ClientSenderExtension
    {
        public static void Send(this ClientSenderRequest requester,ClientEntity entity, string package)
        {
            requester.Handle(entity, Encoding.UTF8.GetBytes(package + "\n"));
        }
    }
}
